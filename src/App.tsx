...
function App() {
  ...
  return (
    <LocaleCtx.Provider value={locale}>
      <main className="min-h-screen bg-[#F0F9FF] text-[#0C4A6E]">
  ...
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-[#0284C7]/10 bg-[#F0F9FF]/88 text-[#0C4A6E] shadow-sm shadow-[#0C4A6E]/5 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-6 text-sm font-semibold text-[#0C4A6E]/75 lg:flex">
          <a className="transition hover:text-[#0C4A6E]" href={link('/')}>{t.nav.home}</a>
          <a className="transition hover:text-[#0C4A6E]" href={link('/#services')}>{t.nav.services}</a>
          <a className="transition hover:text-[#0C4A6E]" href={link(t.services.cards[0].href)}>{t.nav.interior}</a>
          <a className="transition hover:text-[#0C4A6E]" href={link(t.services.cards[1].href)}>{t.nav.exterior}</a>
          <a className="transition hover:text-[#0C4A6E]" href={link('/#realisations')}>{t.nav.projects}</a>
          <a className="transition hover:text-[#0C4A6E]" href={link('/#avis')}>{t.nav.reviews}</a>
          <a className="transition hover:text-[#0C4A6E]" href={link('/#contact')}>{t.nav.contact}</a>
        </div>
...
function BeforeAfterSlider({ before, after }: { before: string; after: string }) {
  ...
  return (
    <div
      ref={ref}
      className="relative w-full cursor-col-resize select-none overflow-hidden rounded-[2rem] shadow-2xl shadow-[#0C4A6E]/50"
    ...
    >
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex h-11 w-11 items-center justify-center rounded-full bg-white shadow-2xl shadow-[#0C4A6E]/50 ring-2 ring-white/30">
          <svg className="h-5 w-5 text-neutral-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M8 9l-4 3 4 3M16 9l4 3-4 3" />
          </svg>
        </div>
      </div>
      <span className="pointer-events-none absolute left-3 top-3 rounded-full bg-[#0C4A6E]/70 px-3 py-1 text-xs font-black uppercase tracking-widest text-white backdrop-blur-sm">{t.slider.before}</span>
      <span className="pointer-events-none absolute right-3 top-3 rounded-full bg-[#0C4A6E]/70 px-3 py-1 text-xs font-black uppercase tracking-widest text-white backdrop-blur-sm">{t.slider.after}</span>
    </div>
  )
}
...
function ServicesSection() {
  ...
  return (
    <section id="services" className="bg-[#F0F9FF] px-4 py-12 text-[#0C4A6E] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-4 md:grid-cols-4">
          {t.services.stats.map((stat) => (
            <div key={stat} className="rounded-3xl border border-[#E0F2FE] bg-white p-5 text-center shadow-xl shadow-stone-900/5">
              <p className="text-lg font-black tracking-tight">{stat}</p>
            </div>
          ))}
        </div>
        <div className="mt-12 max-w-3xl">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-[#0C4A6E]">{t.services.eyebrow}</p>
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-3">
          {t.services.cards.map((service, i) => {
            ...
            return (
              <a key={service.title} href={withLocale(locale, service.href)} className="group rounded-[2rem] border border-[#E0F2FE] bg-white p-6 shadow-2xl shadow-stone-900/8 transition hover:-translate-y-1 hover:shadow-stone-900/15">
                <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0284C7] text-[#F0F9FF] transition group-hover:bg-[#0C4A6E] group-hover:text-white">
...
function InteriorSection() {
  ...
  return (
    <section id="interieur" className="bg-white px-4 py-16 text-[#0C4A6E] sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div className="rounded-[2rem] bg-[#0C4A6E] p-6 text-white shadow-2xl shadow-neutral-950/20 lg:p-8">
          <div className="flex h-16 w-16 items-center justify-center rounded-3xl bg-[#0284C7] text-white">
          ...
          <a href={withLocale(locale, t.interior.href)} className="mt-7 inline-flex items-center gap-3 rounded-full bg-[#0284C7] px-7 py-4 font-black text-white">
            {t.interior.cta}
          </a>
        </div>
        <div className="grid gap-4 sm:grid-cols-2">
          {t.interior.processPoints.map((point) => (
            <div key={point} className="rounded-3xl border border-[#E0F2FE] bg-[#F0F9FF] p-5">
              <CheckCircle2 className="h-6 w-6 text-[#0C4A6E]" />
...
function ProjectsSection() {
  ...
  return (
    <section id="realisations" className="bg-[#F0F9FF] px-4 py-20 text-[#0C4A6E] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.22em] text-[#0C4A6E]">{t.projects.eyebrow}</p>
            <h2 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">{t.projects.h2}</h2>
            <p className="mt-3 max-w-2xl text-lg text-[#0C4A6E]">{t.projects.description}</p>
          </div>
          <div className="flex shrink-0 gap-2">
            {([['all', t.projects.filterAll], ['interior', t.projects.filterInterior], ['exterior', t.projects.filterExterior]] as const).map(([key, label]) => (
              <button
                ...
                className={`rounded-full px-5 py-2 text-sm font-black transition ${filter === key ? 'bg-[#0284C7] text-white' : 'border border-[#E0F2FE] bg-white text-[#0C4A6E] hover:bg-[#F0F9FF]'}`}
              >
                {label}
              </button>
            ))}
          ...
          {filtered.map((project) => (
            ...
            >
              <div className="relative aspect-[16/9] overflow-hidden rounded-t-[2rem] bg-gradient-to-br from-[#0C4A6E] via-[#0C4A6E] to-[#0284C7]">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0C4A6E]/65 via-transparent to-transparent" />
                <div className="absolute left-4 top-4 flex gap-2">
                  <span className="rounded-full bg-[#0284C7]/90 px-3 py-1 text-xs font-black uppercase tracking-[0.14em] text-white backdrop-blur">
                    {t.projects.badge}
                  </span>
                  <span className="rounded-full bg-[#0C4A6E]/70 px-3 py-1 text-xs font-black uppercase tracking-[0.14em] text-white/80 backdrop-blur">
    ...
    <section className="bg-[#0C4A6E] px-4 py-16 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
        ...
        <div className="rounded-[2rem] border border-[#FB923C]/30 bg-[#F0F9FF] p-7 text-[#0C4A6E] shadow-2xl shadow-[#0C4A6E]/30">
          ...
          <a href={PHONE_LINK} className="mt-6 inline-flex items-center justify-center gap-3 rounded-full bg-[#0C4A6E] px-7 py-4 font-black text-white">
            <Phone className="h-5 w-5" />
            {PHONE_NUMBER}
          </a>
        </div>
...
function ReviewsSection() {
  ...
  return (
    <section id="avis" className="bg-white px-4 py-16 text-[#0C4A6E] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <SectionHeader eyebrow={t.reviews.eyebrow} title={t.reviews.h2} />
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {t.reviews.items.map((review) => (
            <article key={review.name} className="rounded-[2rem] border border-[#E0F2FE] bg-[#F0F9FF] p-6 shadow-xl shadow-stone-900/5">
              <Quote className="h-8 w-8 text-[#0C4A6E]" />
              <div className="mt-4 flex text-[#0C4A6E]" aria-label="5 stars">
...
function FaqSection() {
  ...
  return (
    <section className="bg-[#F0F9FF] px-4 py-16 text-[#0C4A6E] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        <SectionHeader eyebrow={t.faq.eyebrow} title={t.faq.h2} />
        <div className="mt-8 grid gap-4">
          {t.faq.items.map((faq) => (
            <details key={faq.question} className="rounded-3xl border border-[#E0F2FE] bg-white p-6 shadow-xl shadow-stone-900/5">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          {faqLinks.map((link) => (
            <a key={link.href} href={link.href} className="rounded-full border border-[#E0F2FE] bg-white px-4 py-2 text-sm font-bold text-[#0C4A6E] shadow-sm transition hover:bg-slate-50">
              {link.label}
            </a>
          ))}
        </div>
...
function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-[#0C4A6E] px-4 py-16 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
...
function SeoLandingPage({ page }: { page: SeoPageDef }) {
  ...
  return (
    <>
      ...
      <section className="bg-white px-4 py-16 text-[#0C4A6E] sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-2">
          {page.sections.map((section) => (
            <article key={section.heading} className="rounded-[2rem] border border-[#E0F2FE] bg-[#F0F9FF] p-7">
...
function SoumissionPage({ page }: { page: SeoPageDef }) {
  ...
  return (
    <>
      ...
      <section className="bg-[#0C4A6E] px-4 pb-20 sm:px-6 lg:px-8">
...
function SectionHeader({ eyebrow, title }: { eyebrow: string; title: string }) {
  return (
    <div className="max-w-3xl">
      <p className="text-sm font-black uppercase tracking-[0.22em] text-[#0C4A6E]">{eyebrow}</p>
...
function BlogPage({ post, locale }: { post: BlogPost; locale: string }) {
  ...
  return (
    <>
      ...
      <article className="bg-[#0C4A6E] px-4 pb-16 sm:px-6 lg:px-8">
      ...
      <section className="bg-[#0C4A6E] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <p className="mt-4 text-lg leading-8 text-[#F0F9FF]">{post.ctaBody}</p>
            <div className="mt-6 flex flex-wrap gap-3">
...
function RichServicePageComponent({ page, locale }: { page: RichServicePageData; locale: string }) {
  ...
  return (
    <>
      <section className="bg-[#0C4A6E] px-4 pb-14 pt-32 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_0.42fr] lg:items-center">
          <div>
            <Breadcrumb crumbs={[{ label: page.eyebrow }]} />
            <p className="text-sm font-black uppercase tracking-[0.24em] text-[#FB923C]">{page.eyebrow}</p>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {page.steps.map((step) => (
              <div key={step.num} className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
                <span className="text-4xl font-black text-[#0C4A6E]">{step.num}</span>
      ...
      <section className="bg-white px-4 py-16 text-[#0C4A6E] sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-2">
          {page.sections.map((s) => (
            <article key={s.h2} className="rounded-[2rem] border border-[#E0F2FE] bg-[#F0F9FF] p-7">
      ...
      <section className="bg-[#0C4A6E] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <p className="mt-4 text-lg leading-8 text-[#F0F9FF]">{page.ctaBody}</p>
            <PhoneBar />
          </div>
          <ContactForm />
        </div>
...
function RelatedServices({ excludePath }: { excludePath: string }) {
  ...
  return (
    <section className="border-t border-white/10 bg-[#0C4A6E] px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
...
function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-[#0C4A6E] px-4 pb-8 pt-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
